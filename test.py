...
def get_argparser():
    ...
    parser.add_argument('--compare', type=str, default='solve05', help='directory name under ./out/ to use as a baseline for comparison')
    parser.add_argument('--show-comparison', type=str, nargs='*', default=['solve05', 'old_solver'], help='List of additional past trials to show in the final comparison table.')
    return parser
