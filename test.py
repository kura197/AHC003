...
def get_argparser():
    ...
    parser.add_argument('--show-comparison', type=str, nargs='*', default=['solve08', 'old_solver', 'eivour', 'thunder'], help='List of additional past trials to show in the final comparison table.')
    return parser
