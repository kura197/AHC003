...
def get_argparser():
    ...
    parser.add_argument('--compare', type=str, default='solve09', help='directory name under ./out/ to use as a baseline for comparison')
    parser.add_argument('--show-comparison', type=str, nargs='*', default=['solve09', 'old_solver', 'eivour', 'thunder'], help='List of additional past trials to show in the final comparison table.')
    return parser
